...
export default function CreateEvent() {
  ...
  return (
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="dc_team" className="text-right">
              DC Team
            </Label>
            <Input id="dc_team" {...register("dc_team", { required: "DC Team is required" })} className="col-span-3" />
            {errors.dc_team && <p className="text-red-500 text-sm col-span-4">{errors.dc_team.message}</p>}
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
